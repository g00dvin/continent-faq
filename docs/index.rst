.. Continent documentation master file, created by
...
АПКШ Континент - программно-аппаратный комплекс для поддержания сетевого нейтралитета производства компании Код Безопасности.
...
.. attention::
    ...
    * Дима, Дима, давайте уже коммитить 
