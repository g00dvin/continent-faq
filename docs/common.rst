...
.. table:: Версии ПО
   ...
   +------------+-------+--------------+----------------+-----------------+----------------+-----------+
   | Исполнение | Класс | Обязательные | Необязательные | СКЗИ М-506А-ХР  | СКЗИ КриптоПро | Сборка    | 
   |            |       | компоненты   | компоненты     | СЗИ SecretNet 7 | CSP 4.0        |           |
   +============+=======+==============+================+=================+================+===========+
   | 1          | КС2   | ЦУС, ПУ ЦУС  | КШ, АРМ ГК *   | +               | -              | 3.7.3.536 |
   |            |       |              |                |                 |                | 3.7.5.426 |
   |            |       |              |                |                 |                | 3.7.5.493 |
   |            |       |              |                |                 |                | 3.7.6.602 |
   |            |       |              |                |                 |                | 3.7.7.671 |
