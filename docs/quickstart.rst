...
АПКШ Континент, в случае его приобретения, поставляется с предустановленной, на производстве Кода Безопасности, текущей тиражируемой версией ПО. 
В некоторых случая может потребоваться переустановка ПО (понижение или повышение версии, восстановление работоспособности, установка отладочной версии по и т.д.).
...
* dd (Linux)
* `Win32DiskImager <https://sourceforge.net/projects/win32diskimager/>`_ (Windos)
